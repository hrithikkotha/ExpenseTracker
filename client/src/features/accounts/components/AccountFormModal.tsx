          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 pb-6">
              ...
              <div>
                ...
                <select
                  {...register('icon')}
                  className="w-20 px-2 py-2 text-2xl text-center border-2 border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-background text-foreground"
                >
              ...
              <div>
                ...
                <select
                  {...register('currency')}
                  className="w-full max-w-xs px-4 py-3 text-base border-2 border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary bg-background text-foreground"
                >
